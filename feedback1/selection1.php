...
<form action="intermediate.php" method="post">
  ...
  <label> Select academic year</label>
    ...
    <label> Select your year</label>
       <select name="year" id="year" required onChange="yearfn(this.value);" class="form-control action">
...
<label> Select Semester</label>
       <select name="country" id="sem" required class="form-control action">
    <option value="">Select Semester</option>
   </select>
   <br />
   <label> Select Subject</label>
   <select name="state" id="state" required class="form-control action">
